                        ...
                        <div class="col-lg-4 mb-5">
                            <div class="card h-100 shadow border-0">
                                ...
                                <div class="card-body p-4">
                                    ...
                                    <a class="text-decoration-none link-dark stretched-link" href="#!"><h5 class="card-title mb-3">hotel zeton</h5></a>
                                    <p class="card-text mb-0">the oils in ait ourir hotel you eat the oils in your live </p>
                                </div>
                                <div class="card-footer p-4 pt-0 bg-transparent border-top-0">
                                    <div class="d-flex align-items-end justify-content-between">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="small">
                                                <div class="fw-bold">marrakche</div>
