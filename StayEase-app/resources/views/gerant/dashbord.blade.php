...
<div class="d-flex">
    ...
    <div class="container-fluid d-flex justify-content-between align-items-center">
        <h1 class="h3 fw-bold text-secondary mb-0">Mes Hôtels</h1>
        ...
        <div class="d-flex gap-2 align-items-center">
            ...
            <a href="{{ route('rooms.create', ['hotel_id' => request('hotel_id')]) }}" class="btn btn-outline-primary shadow-sm">
                <i class="bi bi-door-open me-1"></i> Ajouter chambre
            </a>

            <a href="{{ route('user.logout') }}" class="btn btn-danger shadow-sm ms-3">
